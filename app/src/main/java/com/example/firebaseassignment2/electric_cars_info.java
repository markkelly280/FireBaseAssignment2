...
public class electric_cars_info extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) Button home = (Button) findViewById(R.id.homeE_btn);
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent h = new Intent(electric_cars_info.this, MainActivity.class);
                startActivity(h);
            }
        });
